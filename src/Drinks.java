...
*
*  Brief Description: 
*  Drinks class is an abstract class and the parent class of SoftDrinks class
*  and Coffee class.
*/
...
class SoftDrinks extends Drinks {
    ...
    SoftDrinks(int id, String name, double price){
        this.id = id;
        this.name = name;
        this.price = price;
    }
    ...
    //Parameterised constructor
    SoftDrinks(int id, String name, double price, int quantity, String variation){
        this.id = id;
        this.name = name;
        this.price = price;
...
class Coffee extends Drinks {
    ...
    //Parameterised constructor
    Coffee(int id, String name, double price, int quantity, String variation){
        this.id = id;
        this.name = name;
        this.price = price;
        this.quantity = quantity;
